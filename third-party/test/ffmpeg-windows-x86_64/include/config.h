...
#define FFMPEG_CONFIGURATION "--prefix=/d/a/sunshine-build-deps/sunshine-build-deps/ffmpeg_build --pkg-config-flags=--static --extra-cflags=-I/d/a/sunshine-build-deps/sunshine-build-deps/ffmpeg_build/include --extra-ldflags=-L/d/a/sunshine-build-deps/sunshine-build-deps/ffmpeg_build/lib --extra-libs='-lpthread -lm' --bindir=/d/a/sunshine-build-deps/sunshine-build-deps/bin --disable-all --disable-autodetect --disable-iconv --enable-avcodec --enable-encoder='libx264,libx265' --enable-gpl --enable-libx264 --enable-libx265 --enable-static --enable-swscale --pkg-config=pkg-config --enable-amf --enable-cuda --enable-d3d11va --enable-encoder='h264_amf,hevc_amf' --enable-encoder='h264_mf,hevc_mf' --enable-encoder='h264_nvenc,hevc_nvenc' --enable-ffnvcodec --enable-nvenc --enable-mediafoundation"
#define FFMPEG_LICENSE "GPL version 2 or later"
#define CONFIG_THIS_YEAR 2022
#define FFMPEG_DATADIR "/d/a/sunshine-build-deps/sunshine-build-deps/ffmpeg_build/share/ffmpeg"
#define AVCONV_DATADIR "/d/a/sunshine-build-deps/sunshine-build-deps/ffmpeg_build/share/ffmpeg"
